...
local_dir_zip = "/Userdata/proj2025/kpidata/kpi_zip"
local_dir_files = "/Userdata/proj2025/kpidata/kpi_files"

# local_dir_zip = r"/var/openkpi/kpi_files"
os.makedirs(local_dir_zip, exist_ok=True)
...
def download_and_rename_files(server_ip, username, password, remote_directory):
    try:
        ...
        for file_name in remote_files:
            ...
            if file_name.startswith("PM.BTS") and file_name.endswith(".ANY.raw.gz"):
                ...
                local_file_zip = os.path.join(local_dir_zip, new_file_name)
                local_file_path = os.path.join(local_dir_files, new_file_name)
                ...
                try:
                    for filename in os.listdir(local_dir_zip):
                        file_path = os.path.join(local_dir_zip, filename)
