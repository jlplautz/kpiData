...
docker run --name kpiAirScale -e POSTGRES_USER=Solis -e POSTGRES_PASSWORD=Solis2025 -e POSTGRES_DB=kpiAirScale -d -p 5433:5432 -v pgdata:/Userdata/postgresql/data postgres:11
